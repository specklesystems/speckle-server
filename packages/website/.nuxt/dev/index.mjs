globalThis._importMeta_={url:import.meta.url,env:process.env};import 'file:///home/bender/source/server-website/packages/website/node_modules/node-fetch-native/dist/polyfill.mjs';
import { Server } from 'node:http';
import { tmpdir } from 'node:os';
import { join } from 'node:path';
import { mkdirSync } from 'node:fs';
import { parentPort, threadId } from 'node:worker_threads';
import { defineEventHandler, handleCacheHeaders, createEvent, eventHandler, setHeaders, sendRedirect, proxyRequest, setResponseStatus, getRequestHeader, setResponseHeader, getRequestHeaders, createApp, createRouter as createRouter$1, toNodeListener, fetchWithEvent, lazyEventHandler, getQuery as getQuery$1, createError } from 'file:///home/bender/source/server-website/packages/website/node_modules/h3/dist/index.mjs';
import { createRenderer } from 'file:///home/bender/source/server-website/packages/website/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file:///home/bender/source/server-website/packages/website/node_modules/devalue/index.js';
import { createFetch as createFetch$1, Headers } from 'file:///home/bender/source/server-website/packages/website/node_modules/ofetch/dist/node.mjs';
...
import { parseURL, withoutBase, joinURL, getQuery, withQuery } from 'file:///home/bender/source/server-website/packages/website/node_modules/ufo/dist/index.mjs';
...
const _inlineRuntimeConfig = {
  ...
  "public": {
    ...
    "speckleUserId": "",
    "speckleUrl": "",
    "speckleSampleProjectId": "",
    "speckleSampleModelId": ""
  }
};
...
const getClientManifest = () => import('/home/bender/source/server-website/packages/website/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
