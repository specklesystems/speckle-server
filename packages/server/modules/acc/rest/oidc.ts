...
export const accOidc = (app: Express) => {
  ...
  app.post('/api/v1/acc/auth/login', sessionMiddleware, async (req, res) => {
  ...
  app.get('/api/v1/acc/auth/callback', sessionMiddleware, async (req, res) => {
  ...
  app.get('/api/v1/acc/auth/status', sessionMiddleware, (req, res) => {
  ...
  app.post('/api/v1/acc/auth/refresh', sessionMiddleware, async (req, res) => {
