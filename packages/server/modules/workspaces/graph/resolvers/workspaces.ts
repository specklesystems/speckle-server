...
import { Roles, WorkspaceRoles, isNullOrUndefined, removeNullOrUndefinedKeys } from '@speckle/shared'
...
import { ExecutionEngineFailedResponseError, ExecutionEngineNetworkError } from '@/modules/automate/errors/executionEngine'
        ...
        try {
          const res = await getFunctions({
            query: {
              ...
              functionsWithoutVersions: false,
              workspaceId: parent.id
            }
          })
