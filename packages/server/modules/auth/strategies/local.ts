...
export const verifyLoginRequestHandlerFactory =
  (deps: {
...
export const verifyRegistrationRequestHandlerFactory =
  (deps: {
...
export const localStrategyBuilderFactory =
  (deps: {
    validateUserPassword: ValidateUserPassword
    getUserByEmail: LegacyGetUserByEmail
    getServerInfo: GetServerInfo
  ...
  async (
    ...
    app.post(
      ...
      sessionMiddleware,
      moveAuthParamsToSessionMiddleware,
      verifyLoginRequestHandlerFactory(deps),
      finalizeAuthMiddleware
    )
    ...
    app.post(
      ...
      sessionMiddleware,
      moveAuthParamsToSessionMiddleware,
      verifyRegistrationRequestHandlerFactory(deps),
      finalizeAuthMiddleware
    )
