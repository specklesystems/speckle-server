...
export default {
  ...
  components: {
    ...
    UserInfoCard: () => import('@/cleanup/components/user/UserInfoCard'),
    UserAccessTokens: () => import('@/cleanup/components/user/UserAccessTokens'),
    UserApps: () => import('@/cleanup/components/user/UserApps'),
    UserAuthorisedApps: () => import('@/cleanup/components/user/UserAuthorisedApps'),
    UserDeleteCard: () => import('@/cleanup/components/user/UserDeleteCard')
  },
  data: () => ({}),
  apollo: {
    user: {
