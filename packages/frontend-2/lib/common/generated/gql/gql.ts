...
type Documents = {
  ...
  '\n  query UserActiveWorkspaceSlug {\n    activeUser {\n      id\n      activeWorkspace {\n        id\n        slug\n      }\n    }\n  }\n': typeof types.UserActiveWorkspaceSlugDocument
...
const documents: Documents = {
  ...
  '\n  fragment WorkspaceSwitcherActiveWorkspace_User on User {\n    id\n    activeWorkspace {\n      ...WorkspaceSwitcherActiveWorkspace_LimitedWorkspace\n    }\n    expiredSsoSessions {\n      id\n      ...HeaderWorkspaceSwitcherHeaderExpiredSso_LimitedWorkspace\n    }\n    discoverableWorkspaces {\n      id\n    }\n    workspaceJoinRequests(filter: $joinRequestFilter) {\n      totalCount\n    }\n  }\n':
    types.WorkspaceSwitcherActiveWorkspace_UserFragmentDoc,
  '\n  fragment HeaderWorkspaceSwitcherHeaderExpiredSso_LimitedWorkspace on LimitedWorkspace {\n    id\n    slug\n    name\n    logo\n  }\n':
  ...
  '\n  fragment ProjectPageSettingsTokens_EmbedToken on EmbedToken {\n    createdAt\n    lastUsed\n    tokenId\n    resourceIdString\n    user {\n      id\n      avatar\n      name\n    }\n  }\n':
    types.ProjectPageSettingsTokens_EmbedTokenFragmentDoc,
  '\n  fragment ProjectPageSettingsTokens_Project on Project {\n    id\n    name\n    permissions {\n      canReadEmbedTokens {\n        ...FullPermissionCheckResult\n      }\n      canRevokeEmbedTokens {\n        ...FullPermissionCheckResult\n      }\n    }\n    embedTokens(cursor: $cursor, limit: 20) {\n      cursor\n      totalCount\n      items {\n        ...ProjectPageSettingsTokens_EmbedToken\n      }\n    }\n  }\n':
    types.ProjectPageSettingsTokens_ProjectFragmentDoc,
  '\n  fragment ProjectPageSettingsWebhooks_Project on Project {\n    id\n    permissions {\n      canUpdate {\n        ...FullPermissionCheckResult\n      }\n    }\n  }\n':
  ...
  '\n  fragment ViewerSavedViewsPanelViewsGroupInner_SavedViewGroup_Paginated on SavedViewGroup {\n    id\n    views(input: $savedViewsInput) {\n      cursor\n      totalCount\n      items {\n        id\n        ...ViewerSavedViewsPanelView_SavedView\n      }\n    }\n  }\n':
    types.ViewerSavedViewsPanelViewsGroupInner_SavedViewGroup_PaginatedFragmentDoc,
  '\n  query ViewerSavedViewsPanelViewsGroupInner_Views(\n    $projectId: String!\n    $groupId: ID!\n    $savedViewsInput: SavedViewGroupViewsInput!\n  ) {\n    project(id: $projectId) {\n      id\n      savedViewGroup(id: $groupId) {\n        id\n        ...ViewerSavedViewsPanelViewsGroupInner_SavedViewGroup_Paginated\n      }\n    }\n  }\n':
    types.ViewerSavedViewsPanelViewsGroupInner_ViewsDocument,
  '\n  fragment WorkspaceAddProjectMenu_Workspace on Workspace {\n    id\n    name\n    slug\n    role\n    plan {\n      name\n    }\n    permissions {\n      canCreateProject {\n        ...FullPermissionCheckResult\n      }\n      canMoveProjectToWorkspace {\n        ...FullPermissionCheckResult\n      }\n    }\n    ...ProjectsAdd_Workspace\n    ...WorkspaceMoveProject_Workspace\n    ...UseCanCreateWorkspaceProject_Workspace\n    ...UseCanMoveProjectIntoWorkspace_Workspace\n  }\n':
  ...
  '\n  fragment WorkspaceInviteCard_LimitedWorkspace on LimitedWorkspace {\n    id\n    name\n    slug\n    description\n    logo\n    adminTeam {\n      user {\n        id\n        name\n        avatar\n      }\n    }\n    team {\n      totalCount\n      items {\n        user {\n          id\n          name\n          avatar\n        }\n      }\n    }\n  }\n':
    types.WorkspaceInviteCard_LimitedWorkspaceFragmentDoc,
  '\n  fragment WorkspaceInviteCard_PendingWorkspaceCollaborator on PendingWorkspaceCollaborator {\n    id\n    workspace {\n      ...WorkspaceInviteCard_LimitedWorkspace\n    }\n    invitedBy {\n      id\n      name\n    }\n  }\n':
  ...
  '\n  fragment InviteProjectItem_WorkspaceCollaborator on WorkspaceCollaborator {\n    id\n    user {\n      id\n      name\n    }\n    seatType\n    role\n  }\n':
    types.InviteProjectItem_WorkspaceCollaboratorFragmentDoc,
  '\n  mutation CreateNewRegion($input: CreateServerRegionInput!) {\n    serverInfoMutations {\n      multiRegion {\n        create(input: $input) {\n          id\n          ...SettingsServerRegionsAddEditDialog_ServerRegionItem\n          ...SettingsServerRegionsTable_ServerRegionItem\n        }\n      }\n    }\n  }\n':
    types.CreateNewRegionDocument,
  '\n  mutation UpdateRegion($input: UpdateServerRegionInput!) {\n    serverInfoMutations {\n      multiRegion {\n        update(input: $input) {\n          id\n          ...SettingsServerRegionsAddEditDialog_ServerRegionItem\n          ...SettingsServerRegionsTable_ServerRegionItem\n        }\n      }\n    }\n  }\n':
    types.UpdateRegionDocument,
  '\n  query NavigationWorkspaceSwitcher($joinRequestFilter: WorkspaceJoinRequestFilter) {\n    activeUser {\n      id\n      ...WorkspaceSwitcherActiveWorkspace_User\n    }\n  }\n':
    types.NavigationWorkspaceSwitcherDocument,
  '\n  query WorkspaceSwitcherHeaderWorkspace($slug: String!) {\n    workspaceBySlug(slug: $slug) {\n      ...HeaderWorkspaceSwitcherHeaderWorkspace_Workspace\n    }\n  }\n':
    types.WorkspaceSwitcherHeaderWorkspaceDocument,
  '\n  query NavigationWorkspaceList(\n    $workspaceFilter: UserWorkspacesFilter\n    $projectFilter: UserProjectsFilter\n  ) {\n    activeUser {\n      id\n      workspaces(filter: $workspaceFilter) {\n        items {\n          id\n          ...HeaderWorkspaceSwitcherWorkspaceListItem_Workspace\n        }\n      }\n      projects(filter: $projectFilter) {\n        totalCount\n      }\n    }\n  }\n':
  ...
  '\n  mutation CreateEmbedToken($token: EmbedTokenCreateInput!) {\n    projectMutations {\n      createEmbedToken(token: $token) {\n        token\n        tokenMetadata {\n          projectId\n          tokenId\n          ...ProjectPageSettingsTokens_EmbedToken\n        }\n      }\n    }\n  }\n':
    types.CreateEmbedTokenDocument,
  '\n  mutation DeleteEmbedToken($projectId: String!, $token: String!) {\n    projectMutations {\n      revokeEmbedToken(projectId: $projectId, token: $token)\n    }\n  }\n':
    types.DeleteEmbedTokenDocument,
  '\n  mutation RevokeEmbedTokens($projectId: String!) {\n    projectMutations {\n      revokeEmbedTokens(projectId: $projectId)\n    }\n  }\n':
    types.RevokeEmbedTokensDocument,
  '\n  query ProjectAccessCheck($id: String!) {\n    project(id: $id) {\n      id\n      permissions {\n        canRead {\n          ...FullPermissionCheckResult\n        }\n      }\n      workspaceId\n    }\n    activeUser {\n      id\n      activeWorkspace {\n        id\n      }\n    }\n  }\n':
  ...
  '\n  query UserActiveWorkspaceSlug {\n    activeUser {\n      id\n      activeWorkspace {\n        id\n        slug\n      }\n    }\n  }\n':
    types.UserActiveWorkspaceSlugDocument,
  '\n  fragment UseViewerUserActivityBroadcasting_Project on Project {\n    id\n    permissions {\n      canBroadcastActivity {\n        ...FullPermissionCheckResult\n      }\n    }\n  }\n':
  ...
  '\n  query CanViewProjectTokens($projectId: String!) {\n    project(id: $projectId) {\n      id\n      permissions {\n        canReadEmbedTokens {\n          ...FullPermissionCheckResult\n        }\n      }\n    }\n  }\n':
    types.CanViewProjectTokensDocument,
  '\n  query CanViewProjectSettings($projectId: String!) {\n    project(id: $projectId) {\n      id\n      permissions {\n        canReadSettings {\n          ...FullPermissionCheckResult\n        }\n      }\n    }\n  }\n':
