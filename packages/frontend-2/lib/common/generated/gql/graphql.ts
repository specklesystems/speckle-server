...
export type AutomationsFunctionsCard_AutomateFunctionFragment = { __typename?: 'AutomateFunction', id: string, name: string, isFeatured: boolean, description: string, creator: { __typename?: 'LimitedUser', id: string, name: string, avatar?: string | null } };
...
export type ProjectPageAutomationsEmptyState_QueryFragment = { __typename?: 'Query', automateFunctions: { __typename?: 'AutomateFunctionCollection', items: Array<{ __typename?: 'AutomateFunction', id: string, name: string, isFeatured: boolean, description: string, creator: { __typename?: 'LimitedUser', id: string, name: string, avatar?: string | null } }> } };
