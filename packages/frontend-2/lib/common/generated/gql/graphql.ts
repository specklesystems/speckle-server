...
export type ActiveUserMainMetadataQuery = { __typename?: 'Query', activeUser?: { __typename?: 'User', id: string, email?: string | null, name?: string | null, role?: string | null, avatar?: string | null } | null };
...
export type LoginServerInfoQueryVariables = Exact<{ [key: string]: never; }>;


export type LoginServerInfoQuery = { __typename?: 'Query', serverInfo: { __typename?: 'ServerInfo', authStrategies: Array<{ __typename?: 'AuthStrategy', id: string, name: string, url: string }> } };
...
export const LoginServerInfoDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"LoginServerInfo"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"serverInfo"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"AuthStategiesServerInfoFragment"}}]}}]}},...AuthStategiesServerInfoFragmentFragmentDoc.definitions]} as unknown as DocumentNode<LoginServerInfoQuery, LoginServerInfoQueryVariables>;
