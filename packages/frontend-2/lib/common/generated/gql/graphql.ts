...
export type ProjectPageStatsBlockTeamFragment = { __typename?: 'Project', team: Array<{ __typename?: 'LimitedUser', id: string, name: string, avatar?: string | null }> };
...
export type CreateOnboardingProjectMutation = { __typename?: 'Mutation', projectMutations: { __typename?: 'ProjectMutations', createForOnboarding: { __typename?: 'Project', id: string, createdAt: string, name: string, description?: string | null, versionCount: number, modelCount: number, commentThreadCount: number, team: Array<{ __typename?: 'LimitedUser', id: string, name: string, avatar?: string | null }> } } };
...
export type ProjectPageQueryQuery = { __typename?: 'Query', project?: { __typename?: 'Project', id: string, createdAt: string, name: string, description?: string | null, versionCount: number, modelCount: number, commentThreadCount: number, team: Array<{ __typename?: 'LimitedUser', id: string, name: string, avatar?: string | null }> } | null };
...
export type ProjectPageProjectFragment = { __typename?: 'Project', id: string, createdAt: string, name: string, description?: string | null, versionCount: number, modelCount: number, commentThreadCount: number, team: Array<{ __typename?: 'LimitedUser', id: string, name: string, avatar?: string | null }> };
...
export const ProjectPageProjectFragmentDoc = {"kind":"Document","definitions":[{"kind":"FragmentDefinition","name":{"kind":"Name","value":"ProjectPageProject"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"Project"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"createdAt"}},{"kind":"FragmentSpread","name":{"kind":"Name","value":"ProjectPageProjectHeader"}},{"kind":"FragmentSpread","name":{"kind":"Name","value":"ProjectPageStatsBlockTeam"}},{"kind":"FragmentSpread","name":{"kind":"Name","value":"ProjectPageStatsBlockVersions"}},{"kind":"FragmentSpread","name":{"kind":"Name","value":"ProjectPageStatsBlockModels"}},{"kind":"FragmentSpread","name":{"kind":"Name","value":"ProjectPageStatsBlockComments"}}]}},...ProjectPageProjectHeaderFragmentDoc.definitions,...ProjectPageStatsBlockTeamFragmentDoc.definitions,...ProjectPageStatsBlockVersionsFragmentDoc.definitions,...ProjectPageStatsBlockModelsFragmentDoc.definitions,...ProjectPageStatsBlockCommentsFragmentDoc.definitions]} as unknown as DocumentNode<ProjectPageProjectFragment, unknown>;
