...
export type AutomateFunctionPageQuery = { __typename?: 'Query', automateFunction?: { __typename?: 'AutomateFunction', id: string, name: string, logo?: string | null } | null };
