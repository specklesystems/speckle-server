...
export type ProjectModelPageVersionsProjectFragment = { __typename?: 'Project', id: string, model?: { __typename?: 'Model', id: string, versions: { __typename?: 'VersionCollection', totalCount: number, items: Array<{ __typename?: 'Version', id: string, message?: string | null, createdAt: string, previewUrl: string, sourceApplication?: string | null, commentThreadCount: number, authorUser?: { __typename?: 'LimitedUser', id: string, name: string, avatar?: string | null } | null }> } } | null };
