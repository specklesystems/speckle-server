...
export type ProfileEditDialogQuery = { __typename?: 'Query', activeUser?: { __typename?: 'User', id: string, name: string, company?: string | null, bio?: string | null, avatar?: string | null } | null };
...
export const ProfileEditDialogDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"ProfileEditDialog"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"activeUser"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"UserProfileEditDialogBio_User"}}]}}]}},...UserProfileEditDialogBio_UserFragmentDoc.definitions,...UserAvatarEditable_UserFragmentDoc.definitions,...ActiveUserAvatarFragmentDoc.definitions]} as unknown as DocumentNode<ProfileEditDialogQuery, ProfileEditDialogQueryVariables>;
