...
export type ProjectWebhooksQuery = { __typename?: 'Query', project: { __typename?: 'Project', webhooks?: { __typename?: 'WebhookCollection', totalCount?: number | null, items?: Array<{ __typename?: 'Webhook', streamId: string, triggers: Array<string | null>, enabled?: boolean | null, url: string, id: string, description?: string | null, history?: { __typename?: 'WebhookEventCollection', items?: Array<{ __typename?: 'WebhookEvent', status: number, statusInfo: string } | null> | null } | null } | null> | null } | null } };
