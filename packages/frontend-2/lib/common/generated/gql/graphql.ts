...
export type ProjectModelPageDialogEmbedFragment = { __typename?: 'Project', id: string, visibility: ProjectVisibility };
...
export const ProjectModelPageDialogEmbedFragmentDoc = {"kind":"Document","definitions":[{"kind":"FragmentDefinition","name":{"kind":"Name","value":"ProjectModelPageDialogEmbed"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"Project"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"visibility"}}]}}]} as unknown as DocumentNode<ProjectModelPageDialogEmbedFragment, unknown>;
