...
export type CreateOnboardingProjectMutation = { __typename?: 'Mutation', projectMutations: { __typename?: 'ProjectMutations', createForOnboarding: { __typename?: 'Project', name: string, description?: string | null } } };
...
export type ProjectPageProjectFragment = { __typename?: 'Project', name: string, description?: string | null };
...
export const ProjectPageProjectFragmentDoc = {"kind":"Document","definitions":[{"kind":"FragmentDefinition","name":{"kind":"Name","value":"ProjectPageProject"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"Project"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"ProjectPageProjectHeader"}}]}},...ProjectPageProjectHeaderFragmentDoc.definitions]} as unknown as DocumentNode<ProjectPageProjectFragment, unknown>;
