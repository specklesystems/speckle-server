...
<template>
  <div class="flex flex-col w-full max-h-40 overflow-y-auto simple-scrollbar">
    <FormFileUploadZone
      ref="uploadZone"
    ...
    >
      <CommonTiptapTextEditor
        v-model="doc"
        :class="[
          'dark:bg-foundation-2 bg-neutral-100 rounded-lg p-2 sm:p-3 pr-12 border text-sm',
