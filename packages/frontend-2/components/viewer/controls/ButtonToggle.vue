<template>
  <button
    :class="`transition rounded-lg h-8 w-8 sm:w-10 sm:h-10 shrink-0 flex items-center justify-center ${shadowClasses} ${colorClasses} active:scale-[0.9] outline-none`"
  >
    <slot></slot>
  </button>
</template>
