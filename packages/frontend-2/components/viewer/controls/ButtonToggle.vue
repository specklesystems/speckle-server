<template>
  <button
    :class="`transition rounded-lg w-8 sm:w-10 h-8 sm:h-10 shrink-0 flex items-center justify-center ${shadowClasses} ${colorClasses} active:scale-[0.9] outline-none`"
  >
    <slot></slot>
  </button>
</template>
