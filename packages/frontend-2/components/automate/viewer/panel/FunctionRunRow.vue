<template>
  ...
  >
    ...
    <div v-if="expanded" class="px-2 pb-2 space-y-4">
      <!-- Status message -->
      <div class="space-y-1">
        <div class="text-xs font-semibold text-foreground-2">Status</div>
        <div
          v-if="
            [
      ...
      >
        <div class="text-xs font-semibold text-foreground-2">Attachments</div>
      ...
      >
        <div class="text-xs font-semibold text-foreground-2 mb-2">Results</div>
        <div class="space-y-1">
