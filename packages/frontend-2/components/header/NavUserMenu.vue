<template>
  <div>
    <Menu as="div" class="ml-2 flex items-center">
      ...
      >
        <MenuItems
          class="absolute z-50 right-0 md:right-4 top-14 md:top-16 w-full md:w-64 origin-top-right bg-foundation outline outline-2 outline-primary-muted rounded-md shadow-lg overflow-hidden"
        >
