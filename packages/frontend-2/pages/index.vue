    ...
    <header>
      <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <h1 class="text-3xl font-bold leading-tight text-foreground">
          <slot name="title">Design system demo</slot>
        </h1>
      </div>
    </header>
    <main>
      <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div class="px-4 py-8 sm:px-0">
          <div class="rounded-lg border shadow-sm border-foreground-4 bg-background">
            <div class="p-8">
              ...
              <div class="my-8 flex flex-col space-y-4">
                ...
                <div><FormButton to="/" full-width>Full-width button</FormButton></div>
                <div>
                  <FormButton to="/" disabled>Disabled primary button</FormButton>
                </div>
                <div><FormButton to="/" size="big">Big primary button</FormButton></div>
                <div>
