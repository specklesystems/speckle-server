...
export const lightThemeVariables = {
  ...
  '--success-lighter-2': '#EEFEF8',
  '--success-darker': '#1CBA80',

  /* warning variations */
  '--warning': '#FBBF24',
  '--warning-lighter': '#FFD770',
  '--warning-lighter-2': '#FEF9EE',
  '--warning-darker': '#E0AB20',

  /* info variations */
  '--info': '#B9B8CC',
  '--info-lighter': '#D2D1E5',
  '--info-lighter-2': '#EEEEFE',
  '--info-darker': '#6D6B99',

  /* danger variations */
  '--danger': '#C45959',
  '--danger-lighter': '#F78888',
  '--danger-lighter-2': '#FEEEEE',
...
export const darkThemeVariables = {
  ...
  '--success': '#34D399',
  '--success-lighter': '#53EDB5',
  '--success-lighter-2': '#072C1F',
  '--success-darker': '#1CBA80',

  /* warning variations */
  '--warning': '#FBBF24',
  '--warning-lighter': '#FFD770',
  '--warning-lighter-2': '#302303',
  '--warning-darker': '#E0AB20',

  /* info variations */
  '--info': '#B9B8CC',
  '--info-lighter': '#D2D1E5',
  '--info-lighter-2': '#030330',
  '--info-darker': '#6D6B99',

  /* danger variations */
  '--danger': '#F87171',
  '--danger-lighter': '#FF8F8F',
  '--danger-lighter-2': '#300303',
