import { serverLogger } from '#src/observability/logging.js'
import { appFactory as metricsAppFactory } from '#src/observability/metricsApp.js'
import { appFactory } from '#src/server/app.js'
import { getAppPort, getHost, getMetricsPort } from '#src/utils/env.js'
