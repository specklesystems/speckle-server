...
const DefaultSpeckleTextStyle: TextLabelStyle = {
...
export class TextLabel extends Mesh {
  ...
  private _style: TextLabelStyle = Object.assign({}, DefaultSpeckleTextStyle)
  ...
  public set style(value: TextLabelStyle) {
  ...
  public async update(params: TextParams, updateFinished?: () => void) {
