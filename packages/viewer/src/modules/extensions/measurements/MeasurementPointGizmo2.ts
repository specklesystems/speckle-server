...
import { MeasurementPointGizmoStyle } from './MeasurementPointGizmo.js'
...
export class MeasurementPointGizmo2 extends Group {
  ...
  private getNormalIndicatorMaterial() {
    ...
    material.color = new Color(this._style.discColor)
