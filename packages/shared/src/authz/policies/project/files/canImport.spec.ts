...
import { canImportProjectFilesPolicy } from './canImport.js'
...
describe('canImportProjectFilesPolicy', () => {
  const buildSUT = (overrides?: OverridesOf<typeof canImportProjectFilesPolicy>) =>
    canImportProjectFilesPolicy({
  ...
  const buildWorkspaceSUT = (
    overrides?: OverridesOf<typeof canImportProjectFilesPolicy>
  ) =>
    buildSUT({
      getProject: getProjectFake({
        id: 'project-id',
  ...
  it('fails w/o project role even if public', async () => {
    const sut = buildSUT({
      getProjectRole: async () => null,
      getProject: getProjectFake({
        id: 'project-id',
