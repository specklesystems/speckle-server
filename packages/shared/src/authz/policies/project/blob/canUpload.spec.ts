...
import { canUploadProjectBlobPolicy } from './canUpload.js'
...
describe('canUploadProjectBlobPolicy', () => {
  const buildSUT = (overrides?: OverridesOf<typeof canUploadProjectBlobPolicy>) =>
    canUploadProjectBlobPolicy({
  ...
  const buildWorkspaceSUT = (
    overrides?: OverridesOf<typeof canUploadProjectBlobPolicy>
  ) =>
    buildSUT({
      getProject: getProjectFake({
        id: 'project-id',
  ...
  it('fails w/o project role even if public (no public blobs are allowed)', async () => {
    const sut = buildSUT({
      getProjectRole: async () => null,
      getProject: getProjectFake({
        id: 'project-id',
