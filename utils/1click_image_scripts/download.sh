...
wget https://raw.githubusercontent.com/specklesystems/speckle-server/cristi/1click_scripts/utils/1click_image_scripts/setup.py -O setup.py
wget https://raw.githubusercontent.com/specklesystems/speckle-server/cristi/1click_scripts/utils/1click_image_scripts/template-nginx-site.conf -O template-nginx-site.conf
wget https://raw.githubusercontent.com/specklesystems/speckle-server/cristi/1click_scripts/utils/1click_image_scripts/template-docker-compose.yml -O template-docker-compose.yml
